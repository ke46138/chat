...
func pbMsgOneReactionDeserialize(r *pbx.MsgOneReaction) MsgOneReaction {
	...
	return MsgOneReaction{MrrId: int(r.GetMrrid()), Value: r.GetValue(), Count: int(r.GetCount()), Users: r.GetUsers()}
}
